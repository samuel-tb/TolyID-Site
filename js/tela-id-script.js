document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', function () {
        ...
        animalItem.innerHTML = `
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKVcdcCxNofZLWC81XzvCiJ607mWrbUy93Rw&s" alt="Foto do Tatu">
            <p><a href="../html/site.html?id=${animalId}" class="animal-link">ID: ${animalId}</a></p>
        `;
